...
public class CustomerController {
    ...
    @ApiOperation(value = "To get a list of customers.", notes = "Will fetch all customers.")
    @GetMapping
    ...
    public CustomerDTO createNewCustomer(@RequestBody CustomerDTO customerDTO) {
        ...
        CustomerDTO newCreatedDTO = this.customerService.createNewCustomer(customerDTO);
    ...
    @PutMapping("/{id}")
    @ResponseStatus(HttpStatus.OK)
    public CustomerDTO upateCustomer(@PathVariable Long id, @RequestBody CustomerDTO customerDTO) {

        CustomerDTO updated = this.customerService.updateCustomer(id, customerDTO);
    ...
    public CustomerDTO patchCustomer(@PathVariable Long id, @RequestBody CustomerDTO customerDTO) {
        ...
        CustomerDTO patched = this.customerService.patchCustomer(id, customerDTO);
